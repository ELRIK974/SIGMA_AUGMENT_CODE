...
// Déclarée avec let car son contenu est modifié et potentiellement fusionné depuis localStorage
let logQueue = [];
...
function initLogging() {
  ...
  console.log('loggingUtils.js loaded, isConnected:', typeof isConnected); // Log de débogage
}
